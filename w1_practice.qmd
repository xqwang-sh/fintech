...
2. **安装步骤**：
   ...
   - 运行安装程序，按照提示完成安装
   - 启动 VS Code
3. **特别优惠 - GitHub Student 账户**：
   - **免费用户**：GitHub Copilot 有月度限制（免费版本问答次数有限制）
   - **Student 账户**：获得 **GitHub Copilot Pro 免费使用权**（价值 $10/月）
     - 无限制使用 Copilot（AI 代码助手）
     - 比免费用户多得多的问答次数和优先级
   - **申请方式**：访问 https://education.github.com/pack，用学生邮箱注册即可
   - **还包含其他开发工具的优惠**：例如云服务、设计工具等
...
3. **GitHub Copilot**（AI 代码助手 - 强烈推荐！）
   ...
   - **免费使用**：如果你有 GitHub Student 账户（Student 账户免费享用 $10/月 的 Copilot Pro）
